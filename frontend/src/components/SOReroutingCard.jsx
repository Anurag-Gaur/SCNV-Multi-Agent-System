...
function SOReroutingCard({ alert, onActionComplete }) {
  ...
  const severityColors = {
    high:   { bg: 'rgba(239,68,68,0.08)',   border: '#EF4444', text: '#EF4444', badge: 'rgba(239,68,68,0.12)' },
    medium: { bg: 'rgba(245,158,11,0.08)',  border: '#F59E0B', text: '#F59E0B', badge: 'rgba(245,158,11,0.12)' },
    low:    { bg: 'rgba(34,197,94,0.08)',   border: '#22C55E', text: '#22C55E', badge: 'rgba(34,197,94,0.12)' },
  };
